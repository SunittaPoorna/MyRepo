...
<html >
    ...
    <head>
        ...
        <link href="<?php echo base_url()?>/assets/global/jquery-ui-1.12.1.custom/jquery-ui.css" rel="stylesheet" type="text/css" />
...
<!--                            <li class="dropdown dropdown-extended quick-sidebar-toggler">
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2016 &copy; Raksha Kids by Poorna App Systems Pvt Ltd.
...
<![endif]-->
        ...
        <!--<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBpfXuXYfirMNATAYu0dXHqheKSBNABnKw" type="text/javascript"></script>-->
        ...
        <script src="<?php echo base_url()?>/assets/global/scripts/admin.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <script src="<?php echo base_url()?>/assets/layouts/layout4/scripts/layout.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>/assets/layouts/layout4/scripts/demo.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>/assets/layouts/global/scripts/quick-sidebar.min.js" type="text/javascript"></script>
        <script src="<?php echo base_url()?>assets/global/jquery-ui-1.12.1.custom/external/jquery/jquery.js" type="text/javascript"></script>
        <script type="text/javascript">
            var jQuery_1 = $.noConflict(true);
        </script>
        <script src="<?php echo base_url()?>assets/global/jquery-ui-1.12.1.custom/jquery-ui.js" type="text/javascript"></script>
