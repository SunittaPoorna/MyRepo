...
//Update Classes
	...
	@RequestMapping(value = "/classes/{siNo}",method = RequestMethod.PUT)
	public void updateClasses(@RequestBody Classes classes,@PathVariable Long siNo)
	{
		classesService.updateClasses(classes,siNo);
