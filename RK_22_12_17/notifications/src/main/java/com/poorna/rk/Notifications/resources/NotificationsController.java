...
//Update notification
	...
	//Delete notification
		...
		@RequestMapping(value = "/notifications/{siNo}",method = RequestMethod.DELETE)
		public void deleteNotification(@PathVariable Long siNo)
		{
			notificationService.deleteNotification(siNo);
