...
//Update vehiclestaff
	...
	//delete vehiclestaff
		...
		@RequestMapping(value = "/vehiclesstaff/{siNo}",method = RequestMethod.DELETE)
		public void deleteVehicleStaff(@PathVariable Long siNo)
		{
			vehicleStaffService.deleteVehicleStaff(siNo);
